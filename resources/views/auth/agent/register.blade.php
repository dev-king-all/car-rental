                ...
                <div class="nk-split nk-split-page nk-split-md">
                    <div class="nk-split-content nk-block-area nk-block-area-column nk-auth-container bg-white w-lg-45">
                        ...
                        <div class="nk-block nk-block-middle nk-auth-body">
                            <div class="form-note-s2 pt-4"> Switch Registration to:</div>
                            <div class="btn-group text-center">
                                <button type="button" class="btn btn-dim btn-outline-primary"><a href="{{route ('client.register')}}">Client</a></button>
                            ...
                            <div class="form-note-s2 pt-4"> Already have an account ? <a href="{{route ('agent.login')}}"><strong>Sign in instead</strong></a>
                            </div>
