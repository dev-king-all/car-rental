                        ...
                        <div class="nk-split-content nk-block-area nk-block-area-column nk-auth-container bg-white">
                            ...
                            <div class="nk-block nk-block-middle nk-auth-body">
                                ...
                                <div class="btn-group text-center">
                                    <button type="button" class="btn btn-dim btn-outline-primary"><a href="{{route ('client.login')}}">Client</a></button>
                                ...
                                <div class="text-center form-note-s2 pt-4"> New on our platform? <a href="{{route ('agent.register')}}">Create an account</a>
                                </div>
                            ...
                            <div class="slider-wrap w-100 w-max-550px p-3 p-sm-5 m-auto">
                                        <div class="nk-feature nk-feature-center">
                                            <div class="nk-feature-img">
                                                <img class="round" src="{{ asset('./admin/images/slides/schedule.png') }}" srcset="{{ asset('./admin/images/slides/schedule2x.png 2x') }}" alt="">
                                            </div>
                                            <div class="nk-feature-content py-4 p-sm-5">
                                                <h4>Stay Accountable!</h4>
                                                <p>Keep track of the time you spend on Projects/Tasks, you can also access all your Calendar Events in one place.</p>
                                            </div>
                                        </div>
                        </div><!-- .nk-split -->
                    </div><!-- .nk-split -->
