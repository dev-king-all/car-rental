                    ...
                    <div class="nk-sidebar-content" data-simplebar="init"><div class="simplebar-wrapper" style="margin: 0px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: 0px; bottom: 0px;"><div class="simplebar-content-wrapper" style="height: 100%; overflow: hidden scroll;"><div class="simplebar-content" style="padding: 0px;">
                        <div class="nk-sidebar-menu">
                            ...
                            <ul class="nk-menu apps-menu">
                                ...
                                <li class="nk-menu-item">
                                    <a href="html/apps/mailbox.html" class="nk-menu-link" title="" data-original-title="Mailbox">
                                        <span class="nk-menu-icon"><em class="icon ni ni-inbox"></em></span>
                                    </a>
                                </li>
                                <li class="nk-menu-item">
                                    <a href="html/apps/messages.html" class="nk-menu-link" title="" data-original-title="Messages">
                                        <span class="nk-menu-icon"><em class="icon ni ni-chat"></em></span>
                                    </a>
                                </li>
                                <li class="nk-menu-item">
                                    <a href="html/apps/file-manager.html" class="nk-menu-link" title="" data-original-title="File Manager">
                                        <span class="nk-menu-icon"><em class="icon ni ni-folder"></em></span>
                                    </a>
                                </li>
                                <li class="nk-menu-item">
                                    <a href="html/apps/chats.html" class="nk-menu-link" title="" data-original-title="Chats">
                                        <span class="nk-menu-icon"><em class="icon ni ni-chat-circle"></em></span>
                                    </a>
                                </li>
                                <li class="nk-menu-item">
                                    <a href="html/apps/calendar.html" class="nk-menu-link" title="" data-original-title="Calendar">
                                        <span class="nk-menu-icon"><em class="icon ni ni-calendar"></em></span>
                                    </a>
                                </li>
                                <li class="nk-menu-item">
                                    <a href="html/apps/kanban.html" class="nk-menu-link" data-original-title="" title="">
                        ...
                        <div class="nk-sidebar-footer">
                            <ul class="nk-menu nk-menu-md">
                              <li class="nk-menu-hr"></li>
                                <li class="nk-menu-item">
                                    <a href="#" class="nk-menu-link" title="" data-original-title="Switch to..">
                                        <span class="nk-menu-icon"><em class="icon ni ni-grid-add-c"></em></span>
                                    </a>
                                </li>
                                <li class="nk-menu-item">
                                    <a href="#" class="nk-menu-link" title="" data-original-title="Help">
                                        <span class="nk-menu-icon"><em class="icon ni ni-help-fill"></em></span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    </div></div></div></div><div class="simplebar-placeholder" style="width: auto; height: 760px;"></div></div><div class="simplebar-track simplebar-horizontal" style="visibility: hidden;"><div class="simplebar-scrollbar" style="width: 0px; display: none;"></div></div><div class="simplebar-track simplebar-vertical" style="visibility: visible;"><div class="simplebar-scrollbar" style="height: 113px; transform: translate3d(0px, 0px, 0px); display: block;"></div></div></div>
