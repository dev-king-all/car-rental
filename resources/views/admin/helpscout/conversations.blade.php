                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between g-3">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Conversations</h3>
                ...
                <div class="nk-block">
                    <div class="card card-bordered">
                        <div id="schemeDetails" class="nk-iv-scheme-details">
                                ...
                                @endphp
                            @php
                                $new_array1 = (array)$array['customer'];
...
{{--                            {{ dd($customer_array) }}--}}
                            <ul class="nk-iv-wg3-list">
                                <li>
                                    <div class="sub-text">Conversation Id</div>
                                    <div class="lead-text">{{ $array['id'] }}</div>
                                </li>
                                <li>
                                    <div class="sub-text">Subject</div>
                                    <div class="lead-text">{{ $array['subject'] }}</div>
                                </li>
                                <li>
                                    <div class="sub-text">firstName</div>
                                    <div class="lead-text">{{ $customer_array['firstName'] }}</div>
                                </li>
                                <li>
                                    <div class="lead-text">
                                        <h6>conversations</h6>
                            ...
                            <ul class="nk-iv-wg3-list">
                                <li>
                                    <div class="sub-text">mailboxId</div>
                                    <div class="lead-text">{{ $array['mailboxId'] }}</div>
                                </li>
                                <li>
                                    <div class="sub-text">status</div>
                                    <div class="lead-text">{{ $array['status'] }}</div>
                                </li>
                                <li>
                                    <div class="sub-text">lastName</div>
                                    <div class="lead-text">{{ $customer_array['lastName'] }}</div>
                                </li>
                            </ul>
                            <ul class="nk-iv-wg3-list">
                                <li>
                                    <div class="sub-text">Customer Id</div>
                                    <div class="lead-text">{{ $customer_array['id'] }}</div>
                                </li>

                                <li>
                                    <div class="sub-text">threadCount Count</div>
                                    <div class="lead-text">{{ $array['threadCount'] }}</div>
                                </li>
                                <li>
                                    <div class="sub-text">type</div>
                                    <div class="lead-text">{{ $array['type'] }}</div>
                                </li>
