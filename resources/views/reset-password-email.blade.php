    ...
    <tr style="box-sizing: border-box;">
        <td class="py-5" style="box-sizing: border-box; padding-top: 2.75rem; padding-bottom: 2.75rem;">
            ...
            <table class="email-body text-center"
                ...
                <tr style="box-sizing: border-box;">
                    <td class="px-3 px-sm-5 pt-3 pt-sm-5 pb-3"
                        ...
                        <h2 class="email-heading text-success"
                            style="box-sizing: border-box; margin-top: 0; font-family: Roboto,sans-serif; letter-spacing: -0.03em; margin-bottom: 0; font-size: 18px; font-weight: 600; margin: 0; line-height: 1.4; color: #1ee0ac;">
                            Password Reset Successfull</h2></td>
                </tr>
                <tr style="box-sizing: border-box;">
                ...
                <br>
                <tr style="box-sizing: border-box;">
                    <td class="px-3 px-sm-5" style="box-sizing: border-box; padding-right: 1rem; padding-left: 1rem;">
                ...
                <tr style="box-sizing: border-box;">
                    <td class="px-3 px-sm-5 pt-4 pb-3 pb-sm-5"
                        ...
                        <p class="email-note"
                           style="box-sizing: border-box; margin-top: 0; margin-bottom: 0; margin: 0; font-size: 13px; line-height: 22px; color: #8094ae;">
